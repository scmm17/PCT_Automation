...
function makeMailLink(addresses, greeting, isFamily) {
  ...
  if (addresses.length == 1) {
    return '=HYPERLINK("mailto:' + addresses[0] + '?subject=Trinity Cycle of Prayer&body=' + greeting +'", "' + label + '")';
  }
  ...
  return link + '?subject=Trinity Cycle of Prayer&body=' + greeting +' ", "Email Whole Family")';
}
